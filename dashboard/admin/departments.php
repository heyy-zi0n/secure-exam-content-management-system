...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm p-12 text-center">
        ...
        <p class="text-sm text-slate-500 dark:text-slate-400 max-w-sm mx-auto">The <strong>Departments</strong> module is being built. Check back after the next deployment sprint.</p>
    </div>
</div>
